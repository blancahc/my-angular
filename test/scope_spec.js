...
describe('Scope', function (){
    ...
    describe('digest', function() {
        ...
        it('correctly handles NaNs', function() {
            scope.number = 0/0; //will result in NaN
            scope.counter = 0; 
            scope.$watch(
        ...
        it('allows a $watch to destroy another during digeset', function() {
            scope.aValue = 'abc';
            scope.counter = 0;
            scope.$watch(
                function(scope) {
        ...
        it('allows destroying several $watches during digeest', function() {
            scope.aValue = 'abc';
            scope.counter = 0;
    ...
    describe('inheritance', function(){
        ...
        it('digesets from root on $apply', function() {
            var parent = new Scope();
            var child = parent.$new();
    ...
    describe('$watchCollection', function() {
        ...
        it('it works like a normal watch for non-collections', function() {
            var valueProvided;
            scope.aValue = 42;
            scope.counter = 0;
        ...
        it('does not fail on NaN atrributes in objects', function() {
            scope.counter = 0;
            scope.obj = {a: NaN};
